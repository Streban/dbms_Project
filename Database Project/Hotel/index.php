...
<body>
	...
	<div class="banner-top">
		...
		<div class="contact-bnr-w3-agile">
			<ul>
				<li><i class="fa fa-envelope" aria-hidden="true"></i><a href="mailto:info@example.com">INFO@gikhotel.COM</a></li>
				<li><i class="fa fa-phone" aria-hidden="true"></i>+92 (00)100-44-55</li>
				<li class="s-bar">
					<div class="search">
		...
		<div class="container">
			<nav class="navbar navbar-default">
				<div class="navbar-header navbar-left">
					...
					<h1><a class="navbar-brand" href="index.php">GIK <span>HOTEL</span>
		...
		<div class="modal-dialog">
			...
			<div class="modal-content">
				<div class="modal-header">
					...
					<h4>GIK <span>HOTEL</span></h4>
					<img src="images/1.jpg" alt=" " class="img-responsive">
					<h5>We know what you love</h5>
					<p>Providing guests unique and enchanting views from their rooms with its exceptional amenities, makes Star Hotel
						one of bests in its kind.Try our food menu, awesome services and friendly staff while you are here.</p>
				</div>
			</div>
		</div>
	</div>
				...
				<ul class="cbp-ig-grid">
					<li>
						<div class="w3_grid_effect">
							...
							<span class="cbp-ig-category">GIK HOTEL</span>
						</div>
					</li>
					<li>
						<div class="w3_grid_effect">
	...
	<div class="about-wthree" id="about">
		<div class="container">
			<div class="ab-w3l-spa">
				<h3 class="title-w3-agileits title-black-wthree">About Our GIK HOTEL</h3>
				<p class="about-para-w3ls">Providing guests unique and enchanting views from their rooms with its exceptional amenities, makes Star Hotel one of bests in its kind.Try our food menu, awesome services and friendly staff while you are here.</p>
				...
				<div class="advantage-bottom">
					<div class="col-md-6 advantage-grid left-w3ls wow bounceInLeft" data-wow-delay="0.3s">
						<div class="advantage-block ">
							...
							<p><i class="fa fa-check" aria-hidden="true"></i>Booking in advance</p>
							<p><i class="fa fa-check" aria-hidden="true"></i>Payment on checkout</p>
	...
	<div class="team" id="team">
		<div class="container-fluid">
			...
			<div id="horizontalTab">
				...
				<li>
						<img width="120px" height="120px" src="images/Mateen.jfif" alt=" " class="img-responsive" />
					</li>
					<li>
						<img width="120px" height="100px" src="images/maaziyar.jpeg" alt=" " class="img-responsive" />
					</li>
					<li>
						<img width="120px" height="120px" src="images/chakwali.jfif" alt=" " class="img-responsive" />
					</li>
				</ul>
	...
	<section class="contact-w3ls" id="contact">
		<div class="container">
			...
			<div class="col-lg-6 col-md-6 col-sm-6 contact-w3-agile1" data-aos="flip-right">
				...
				<p class="contact-agile1"><strong>Phone :</strong>+94 (00)111-44-55</p>
				<p class="contact-agile1"><strong>Email :</strong> <a href="mailto:name@example.com">INFO@GIK HOTEL.COM</a></p>
				<p class="contact-agile1"><strong>Address :</strong> GIK Institute,Topi,KPK,Pakistan</p>
	...
	<!-- /contact -->
	<div class="copy">
		<p>© 2018 GIK HOTEL . All Rights Reserved | Design by <a href="index.php">GIK HOTEL</a> </p>
	</div>
	<!--/footer -->
	<!-- js -->
