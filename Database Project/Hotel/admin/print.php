...
@page { margin: 0; }
	...
	?>
		<header>
			...
			<address >
				<p>GIK HOTEL,</p>
				<p>GIK Institute,<br>Topi,KPK<br>Pakistan.</p>
				<p>(+94) 65 222 44 55</p>
			</address>
			<span><img alt="" src="assets/img/giki.png"></span>
		</header>
		<article>
			<h1>Recipient</h1>
			<address >
		...
		<aside>
			...
			<div >
				<p align="center">Email :- info@gikhotel.com || Web :- www.gikhotel.com || Phone :- +92 00 111 44 55 </p>
			</div>
		</aside>
	</body>
</html>
